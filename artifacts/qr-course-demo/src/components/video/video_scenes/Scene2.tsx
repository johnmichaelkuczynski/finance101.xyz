  ...
  return (
    ...
    >
      ...
      <div className="w-1/2 h-full border-r border-border p-12 overflow-hidden flex flex-col relative">
        <div className="text-xs font-bold tracking-widest text-muted-foreground mb-4">WEEK 1 — FOUNDATIONS AND THE TIME VALUE OF MONEY</div>
        <h1 className="text-3xl font-serif text-primary mb-8">1.1 What finance is and why it exists</h1>
        ...
        <div className="prose prose-sm max-w-none text-foreground/80 space-y-6">
          <h2 className="font-serif text-2xl text-primary">What is finance?</h2>
          <p>
            Finance is the study of how people and firms <em>allocate scarce resources across time under uncertainty</em>. Before any spreadsheet, valuation model, or option-pricing formula, there is one primitive idea: moving money from when you have it to when you need it, at a price set by an interest rate.
          </p>
          <p>
            The economy is full of <em>surplus units</em> (savers) and <em>deficit units</em> (borrowers and firms with profitable uses). Finance is the machinery that channels funds from the first group to the second and prices the transfer through an expected return.
          </p>
          ...
          <AnimatePresence>
            {phase >= 1 && (
              ...
              >
                <p>
                  Every finance decision reduces to one of three questions: which assets should we hold (<em>investment</em>), how should we pay for them (<em>financing</em>), and how do we measure and bear the uncertainty involved (<em>risk</em>)? The rest of the course is just sharper and sharper tools for answering those three.
                </p>
                <p>
                  The single most important quantitative idea is the <strong>time value of money</strong>: a dollar today is worth more than a dollar tomorrow. We will make that precise with two master formulas — future value $FV = PV(1+r)^n$ and present value $PV = FV/(1+r)^n$ — and use them to price bonds, stocks, and entire companies later in the course.
                </p>
              </motion.div>
            )}
          </AnimatePresence>
            ...
            {phase < 2 || phase >= 4 ? (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  <div className="px-3 py-1.5 rounded-full border border-border text-sm text-primary bg-muted/30">Why is a dollar today worth more than a dollar tomorrow?</div>
                  <div className="px-3 py-1.5 rounded-full border border-border text-sm text-primary bg-muted/30">What's the difference between an investment and a financing decision?</div>
                  <div className="px-3 py-1.5 rounded-full border border-border text-sm text-primary bg-muted/30">Why do riskier cash flows get discounted at a higher rate?</div>
                </div>
                <div className="w-full h-24 border border-border rounded-lg bg-muted/20 p-3 text-muted-foreground text-sm flex items-end shadow-inner">
                  <div className="w-full flex justify-between">
                    <span>Ask a question about what finance is and why it exists...</span>
                ...
                {phase === 2 ? (
                  ...
                  >
                    <p className="text-foreground font-medium mb-6">
                      Write the present value formula for a single cash flow FV received in n periods at discount rate r.
                    </p>
