    ...
    >
      <AnimatePresence mode="wait">
        {phase < 2 ? (
          ...
          >
            <h1 className="text-4xl font-serif text-primary mb-8 tracking-tight">Teach Yourself Finance</h1>
              ...
              <div className="col-span-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <h4 className="font-serif text-lg mb-2">Foundations and the time value of money</h4>
                  ...
                  <div className="bg-white/60 border border-border p-5 rounded-xl opacity-70">
                    ...
                    <h4 className="font-serif text-lg mb-2">Financial statements and analysis</h4>
                    <p className="text-sm text-muted-foreground">7 Lectures · 3 Assignments</p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <h1 className="text-4xl font-serif text-primary mb-8 tracking-tight">Week 1 — Foundations and the time value of money</h1>
              ...
              <div className="divide-y divide-border">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="font-medium">1.1 What finance is and why it exists</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.2 The financial system and markets</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.3 Money, interest, and the time value of money</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.4 Present value and future value</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.5 Discounting cash flows</span>
                  </div>
                  <span className="text-xs text-muted-foreground">14 min</span>
                </div>
              </div>
